...
content_finalizer_prompt = """
    ...
    Assertions:
        ...
        - You MUST use information passed down from the general support agent, formatted as {information_passed_down} 
    ...
    Use the following format:
        ...
        Observation: the result of the action
        ... (this Thought/Action/Action Input/Observation can repeat N times
        Final Thought: I now have all information relevant to question, and ready to render the answer in the best format.
